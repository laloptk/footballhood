<?php
/**
 * footballhood functions and definitions
 *
...
if ( ! function_exists( 'ftblhood_setup' ) ) :
	/**
	 ...
	 */
	function ftblhood_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on footballhood, use a find and replace
		 * to change 'ftblhood' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'ftblhood', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'ftblhood' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'ftblhood_custom_background_args', array(
...
add_action( 'after_setup_theme', 'ftblhood_setup' );
 ...
 */
function ftblhood_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ftblhood_content_width', 640 );
}
add_action( 'after_setup_theme', 'ftblhood_content_width', 0 );
 ...
 */
function ftblhood_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'ftblhood' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'ftblhood' ),
...
add_action( 'widgets_init', 'ftblhood_widgets_init' );
